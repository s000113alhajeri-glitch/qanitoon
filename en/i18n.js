...
Object.assign(EN, {
  ...
  "المُفسد الوحيد:": "The only invalidator:", "قبل الفراغ من السعي؛ تفسد بها العمرة، ويلزم إتمامها ثم قضاؤها، وذبح شاة لفقراء الحرم.": "Intercourse before finishing Sa'i invalidates the Umrah; it must be completed, then repeated, with a sheep sacrificed for the poor of the Haram.",
  "ما عدا ذلك من المحظورات يوجب الفدية والعمرة صحيحة.": "All other prohibitions require expiation, and the Umrah remains valid.",
  "قبل التحلل الأول تُفسد الحج، ويلزم إتمامه وقضاؤه من قابل وذبح بدنة. وبعد التحلل الأول لا تفسده وفيها فدية.": "Intercourse before the first release invalidates the Hajj; it must be completed, repeated the next year, and a camel sacrificed. After the first release it does not invalidate it, but requires expiation.",
...
Object.assign(EN, {
  "أتممت العدد": "Count complete", "بارك الله فيك": "May Allah bless you", "تم الحفظ": "Saved", "متوقف": "Off", "النيّة": "Intention",
