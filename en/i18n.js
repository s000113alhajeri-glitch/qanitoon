...
Object.assign(EN, {
  "أهلاً بك في قانتون": "Welcome to Qanitoon", "أدخل اسمك ورقم هاتفك ثم «حفظ» للدخول": "Enter your name and phone number, then “Save” to continue", "المناسك": "Rites", "نعمة / شكر / فرح / طلب التوفيق والهداية": "Blessing / gratitude / joy / asking for guidance and success", "مسلم ٢٧٢١": "Muslim 2721", "مسلم ٢٧٢٥ — «واذكر بالهدى هدايتك الطريق، وبالسداد سداد السهم»": "Muslim 2725 — “recall, by guidance, being guided on a road, and by steadiness, the straightness of an arrow”", "الترمذي ٢١٤٠ (صحيح) — كان ﷺ يُكثر منه": "At-Tirmidhi 2140 (authentic) — the Prophet ﷺ said it often", "مسلم ٢٧٣٩": "Muslim 2739", "اللَّهُمَّ إِنِّي أَسْأَلُكَ الْهُدَى وَالتُّقَى وَالْعَفَافَ وَالْغِنَى": "O Allah, I ask You for guidance, piety, chastity and sufficiency.", "اللَّهُمَّ اهْدِنِي وَسَدِّدْنِي": "O Allah, guide me and keep me steadfast.", "يَا مُقَلِّبَ الْقُلُوبِ ثَبِّتْ قَلْبِي عَلَى دِينِكَ": "O Turner of hearts, make my heart firm upon Your religion.", "اللَّهُمَّ إِنِّي أَعُوذُ بِكَ مِنْ زَوَالِ نِعْمَتِكَ، وَتَحَوُّلِ عَافِيَتِكَ، وَفُجَاءَةِ نِقْمَتِكَ، وَجَمِيعِ سَخَطِكَ": "O Allah, I seek refuge in You from the loss of Your blessings, the change of Your protection, Your sudden punishment, and all that displeases You.", "﴿رَبَّنَا لَا تُزِغْ قُلُوبَنَا بَعْدَ إِذْ هَدَيْتَنَا وَهَبْ لَنَا مِن لَّدُنكَ رَحْمَةً إِنَّكَ أَنتَ الْوَهَّابُ﴾": "Our Lord, let not our hearts deviate after You have guided us and grant us from Yourself mercy. Indeed, You are the Bestower.", "﴿رَبَّنَا أَتْمِمْ لَنَا نُورَنَا وَاغْفِرْ لَنَا إِنَّكَ عَلَىٰ كُلِّ شَيْءٍ قَدِيرٌ﴾": "Our Lord, perfect for us our light and forgive us. Indeed, You are over all things competent.", "﴿رَبِّ اجْعَلْنِي مُقِيمَ الصَّلَاةِ وَمِن ذُرِّيَّتِي رَبَّنَا وَتَقَبَّلْ دُعَاءِ﴾": "My Lord, make me an establisher of prayer, and from my descendants. Our Lord, and accept my supplication.", "آل عمران ٨": "Al-Imran 3:8", "التحريم ٨": "At-Tahrim 66:8", "إبراهيم ٤٠": "Ibrahim 14:40", "عند الوصول إلى الميقات (أو محاذاته في الطائرة): الاغتسال والتطيّب في البدن، ولبس الإزار والرداء، وركعتان إن تيسّر، ثم يعقد النيّة بقلبه ويتلفّظ بالنُّسك — ولا تلبية قبل ذلك:": "On reaching the miqat (or passing over it in the plane): bathe, apply perfume to the body, put on the izar and rida', pray two rak'ahs if possible, then make the intention in the heart and state the rite aloud — no talbiyah before that:", "الاشتراط: لمن خاف عائقاً، يقوله مرةً واحدة عند عقد الإحرام بعد التلفّظ بالنُّسك؛ لحديث ضُباعة «حُجّي واشترطي» — البخاري ٥٠٨٩، مسلم ١٢٠٧.": "The condition (ishtirat): for one who fears an obstacle, said once when entering ihram after stating the rite; from the hadith of Duba'ah, “Perform Hajj and make the condition” — Al-Bukhari 5089, Muslim 1207.", "القادم بالحج وحده أو قارناً يطوف طواف القدوم ويسعى سعي الحج عند قدومه مكة، ولا يتحلّل. أمّا المتمتّع فهذه الخطوة لا تخصّه؛ اضغط «التالي».": "One arriving for Hajj alone (Ifrad) or Qiran performs the arrival Tawaf and the Sa'i of Hajj on reaching Makkah, and does not exit ihram. For Tamattu' this step does not apply; tap “Next”.", "تسبيح الأنبياء والملائكة": "Tasbih of the prophets and angels", "تسبيح الأنبياء": "Tasbih of the prophets", "تسبيح الملائكة": "Tasbih of the angels", "تسبيح الخلق كلّه": "Tasbih of all creation", "تسبيح علّمنا الله إياه": "Tasbih Allah taught us", "يونس ﷺ": "Yunus (Jonah), peace be upon him", "موسى ﷺ": "Musa (Moses), peace be upon him", "زكريا ﷺ": "Zakariyya (Zechariah), peace be upon him", "داود ﷺ": "Dawud (David), peace be upon him", "الملائكة عند خلق آدم": "The angels at the creation of Adam", "حَمَلة العرش ومن حوله": "The bearers of the Throne and those around it", "دوام تسبيحهم": "Their unceasing glorification", "السماوات والأرض ومن فيهن": "The heavens, the earth and all within them", "عند الركوب": "When riding", "أهل الجنة": "The people of Paradise", "الصيغة:": "Wording:", "بلا عدد محدّد": "No fixed number", "الآيات كما في المصحف بأرقامها؛ والصيغة تُعرض فقط حيث نصّت الآية على لفظها، وما لم تذكره الآية لا نضيفه.": "Verses are shown as in the Quran with their numbers; a wording is shown only where the verse itself states it, and we add nothing the verse does not mention.", "قال ﷺ: «ما دعا بها مسلمٌ في شيء قط إلا استجاب الله له» (الترمذي — صحيح).": "The Prophet ﷺ said: “No Muslim ever supplicates with it for anything but Allah answers him” (Tirmidhi — authentic).", "أُمر بالتسبيح بالعشيّ والإبكار؛ ولم تذكر الآية صيغة بعينها.": "He was commanded to glorify Allah in the evening and morning; the verse does not specify a wording.", "سُخِّرت معه الجبال والطير يسبّحن بالعشيّ والإشراق؛ ولم تذكر الآية صيغة بعينها.": "The mountains and birds were made to glorify Allah with him in the evening and at sunrise; the verse does not specify a wording.", "يسبّحون بحمد ربهم ويستغفرون للمؤمنين؛ ولم تذكر الآية لفظ تسبيحهم.": "They glorify their Lord with praise and seek forgiveness for the believers; the verse does not state the wording of their tasbih.", "وكان ﷺ يزيد بعدها: «وَإِنَّا إِلَى رَبِّنَا لَمُنْقَلِبُونَ» (الزخرف ١٤) وما ورد في دعاء السفر (مسلم).": "The Prophet ﷺ would add after it: “and indeed, to our Lord we will return” (Az-Zukhruf 14) and the travel du'a reported in Muslim.", "لَا إِلَهَ إِلَّا أَنْتَ سُبْحَانَكَ إِنِّي كُنْتُ مِنَ الظَّالِمِينَ": "There is no deity except You; exalted are You. Indeed, I have been of the wrongdoers.", "سُبْحَانَكَ تُبْتُ إِلَيْكَ وَأَنَا أَوَّلُ الْمُؤْمِنِينَ": "Exalted are You! I have repented to You, and I am the first of the believers.", "سُبْحَانَكَ لَا عِلْمَ لَنَا إِلَّا مَا عَلَّمْتَنَا إِنَّكَ أَنْتَ الْعَلِيمُ الْحَكِيمُ": "Exalted are You; we have no knowledge except what You have taught us. Indeed, it is You who is the Knowing, the Wise.", "سُبْحَانَ الَّذِي سَخَّرَ لَنَا هَذَا وَمَا كُنَّا لَهُ مُقْرِنِينَ": "Exalted is He who has subjected this to us, and we could not have otherwise subdued it.", "سُبْحَانَكَ اللَّهُمَّ": "Exalted are You, O Allah.", "فضله في الحديث — انظر الفضل": "Its virtue is in the hadith — see Virtue", "يكتب له ألف حسنة أو يحط عنه ألف خطيئة.": "A thousand good deeds are recorded for him, or a thousand sins are removed from him.", "هدي النبي ﷺ في الدعاء": "The Prophet's ﷺ way in du'a", "التسبيح، هدي النبي ﷺ في الدعاء، بحث القرآن، اسألني": "Tasbih, the Prophet's ﷺ way in du'a, Quran search, Ask me", "أدعيتك المختارة في هدي النبي ﷺ في الدعاء": "Your chosen du'as in the Prophet's ﷺ way in du'a", "هدي النبي ﷺ في الدعاء: أوقات الإجابة الواردة عنه وأدعيته الثابتة فيها فقط، كلٌّ بحديثه ودرجته. يظهر أعلى القائمة ما أنت فيه الآن، ويُنبَّه لما فعّلته. اختيارك للأدعية تسهيلٌ للتذكير، ويجوز لك أن تدعو بما شئت.": "The Prophet's ﷺ way in du'a: only the times of answered du'a reported from him and his established du'as in them, each with its hadith and grading. What you are in now appears at the top, and you are reminded of what you enabled. Choosing du'as is only a reminder aid; you may supplicate with whatever you wish.", "أوقات الإجابة": "Times of answered du'a", "أوقات الإجابة (أوقات الدعاء النبوية)": "Times of answered du'a (Prophetic times of du'a)", "التسبيح، أوقات الإجابة، بحث القرآن، اسألني": "Tasbih, times of answered du'a, Quran search, Ask me", "أدعيتك المختارة في أوقات الإجابة": "Your chosen du'as in Times of answered du'a", "أنا صائم اليوم": "I am fasting today", "أنا صائم اليوم ✓": "I am fasting today ✓", "حذف من أدعيتي": "Remove from my du'as", "حذف": "Remove", "اختر ما تسبّح به اليوم، ثم اضغط «ابدأ التسبيح» ليظهر لكل ذكر عدّاده هنا، ويُحسب مجموعه في «التسبيح اليوم» بالرئيسية.": "Choose what you will glorify Allah with today, then tap “Start tasbih”: each dhikr gets its counter here, and the total counts toward “Today's tasbih” on the home screen.", "ابدأ التسبيح": "Start tasbih", "مختار)": "selected)", "اختر ذكراً واحداً على الأقل": "Choose at least one dhikr", "تعديل الاختيار": "Edit selection", "المزيد": "More", "كل التنبيهات": "All notifications", "مفعّلة": "On", "متوقفة": "Off", "أخذ الحق مشروع, والعفو أعلى": "Taking one's right is permitted; forgiving is higher", "أخذ الحق مشروع، والعفو أعلى": "Taking one's right is permitted; forgiving is higher", "التسبيح، جدولي، بحث القرآن، اسألني": "Tasbih, my schedule, Quran search, Ask me", "سنة النبي ﷺ في رمضان، القضاء، الصيام المستحب": "The Prophet's ﷺ way in Ramadan, make-up fasts, voluntary fasting", "الحج": "Hajj", "العمرة": "Umrah",
  ...
  "تمتّع (عمرة ثم حج، وعليه هدي)، قِران (عمرة وحج بإحرام واحد، وعليه هدي)، إفراد (حج فقط).": "Tamattu' — Umrah and Hajj with two separate intentions: enter ihram for Umrah, complete it and exit ihram, then on 8 Dhul-Hijjah enter ihram again for Hajj (Labbayka Allahumma hajjan); a sacrifice is due. Qiran — Umrah and Hajj with one intention (Labbayka Allahumma umratan wa hajjan): after Umrah you stay in ihram until the Hajj rites; a sacrifice is due. Ifrad — Hajj only, intention made when entering ihram (Labbayka Allahumma hajjan); no sacrifice due.",
...
RULES.unshift([/^ابدأ التسبيح \((\d+) مختار\)$/, (m) => `Start tasbih (${m[1]} selected)`]);
...
/* Arabic (with tashkeel) -> simple Latin transliteration, deterministic. */
function translit(src) {
  const C = { "ب": "b", "ت": "t", "ث": "th", "ج": "j", "ح": "h", "خ": "kh", "د": "d", "ذ": "dh", "ر": "r", "ز": "z", "س": "s", "ش": "sh", "ص": "s", "ض": "d", "ط": "t", "ظ": "z", "ع": "'", "غ": "gh", "ف": "f", "ق": "q", "ك": "k", "ل": "l", "م": "m", "ن": "n", "ه": "h", "و": "w", "ي": "y", "ء": "'", "أ": "'", "إ": "'", "ؤ": "'", "ئ": "'" };
  const isV = c => /[\u064B-\u0652\u0670]/.test(c);
  const vs = v => v.includes("\u064B") ? "an" : v.includes("\u064C") ? "un" : v.includes("\u064D") ? "in" : v.includes("\u064E") ? "a" : v.includes("\u064F") ? "u" : v.includes("\u0650") ? "i" : v.includes("\u0670") ? "a" : "";
  const clean = src.replace(/[﴿﴾«»"“”\u06D6-\u06ED\u0610-\u061A\u0640]/g, "");
  return clean.split(/\s+/).filter(Boolean).map(w => {
    const ch = [...w]; let r = "", i = 0;
    const marks = k => { let v = "", j = k; while (j < ch.length && isV(ch[j])) v += ch[j++]; return [v, j]; };
    const shortV = v => /[\u064E\u064F\u0650\u064B-\u064D]/.test(v) || v.includes("\u0651") && false;
    // definite article ال / ٱل
    if ((ch[0] === "ا" || ch[0] === "ٱ") && ch[1] === "ل") {
      const [, j] = marks(2);
      const next = ch[j], [vn] = marks(j + 1);
      if (next && vn.includes("\u0651") && "تثدذرزسشصضطظلن".includes(next)) { r = "a" + C[next] + "-"; ch.splice(0, j); ch[0] = next; /* keep next with shadda */ i = 0; }
      else { r = "al-"; i = j; }
    }
    while (i < ch.length) {
      const c = ch[i];
      ...
      const [v, j] = marks(i + 1);
      if (c === "ا" || c === "ٱ" || c === "آ") {
        if (i === 0) r += c === "آ" ? "a" : (vs(v) || "a");
        else if (!r.endsWith("a") && !r.endsWith("an")) r += "a";
        i = j; continue;
      }
      if (c === "ى") { if (!r.endsWith("a")) r += "a"; i = j; continue; }
      if (c === "ة") { r += shortV(v) ? "t" + vs(v) : "h"; i = j; continue; }
      if (c === "و" && !shortV(v) && !v.includes("\u0651") && r) { r += r.endsWith("u") ? "" : "w"; i = j; continue; }
      if (c === "ي" && !shortV(v) && !v.includes("\u0651") && r) { r += r.endsWith("i") ? "" : "y"; i = j; continue; }
      let b = C[c] || "";
      if (v.includes("\u0651") && b && !r.endsWith("-")) b = b.length === 1 ? b + b : b;
      else if (v.includes("\u0651") && r.endsWith("-") && r.startsWith("a") && r !== "al-") b = b; // after assimilated article
      if (b === "'" && !r) b = "";
      r += b + vs(v);
      i = j;
    }
    return r.replace(/-$/, "");
  }).join(" ").replace(/\balll?ah/g, "Allah").replace(/al-lah/g, "Allah").replace(/ialll/g, "ill").replace(/alllah/g, "allah").replace(/([^a-z'])allah/g, "$1Allah").replace(/^./, c => c.toUpperCase());
}
const TL_SKIP = /[«»]|قال|قَالَ|رَسُول|حَدَّثَ|رواه|صحيح/;
function annotateMeanings(root) {
  ...
  els.forEach(el => {
    ...
    if (el.matches(".dua") && !el.closest("#v-tadabbur .learn, #qpage") && !TL_SKIP.test(t) && t.length < 260 && /[\u064B-\u0652]/.test(t)) {
      const l = document.createElement("div"); l.className = "ayTl"; l.textContent = translit(t); el.insertAdjacentElement("afterend", l);
    }
  });
}
